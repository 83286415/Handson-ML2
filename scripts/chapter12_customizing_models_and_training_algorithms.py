...
class MyMomentumOptimizer(keras.optimizers.Optimizer):  # a example of custom optimizers. i shall NOT custom it...
...
if __name__ == '__main__':
    ...
    model.compile(loss="mse", optimizer=MyMomentumOptimizer())  # use custom optimizer class
    model.fit(X_train_scaled, y_train, epochs=5)